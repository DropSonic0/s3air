...
namespace lemon
{
	...
	genericmanager::detail::ElementClassImpl<ParserToken, KeywordParserToken, (uint32)ParserToken::Type::KEYWORD> KeywordParserToken::CLASS;
	genericmanager::detail::ElementClassImpl<ParserToken, VarTypeParserToken, (uint32)ParserToken::Type::VARTYPE> VarTypeParserToken::CLASS;
	genericmanager::detail::ElementClassImpl<ParserToken, OperatorParserToken, (uint32)ParserToken::Type::OPERATOR> OperatorParserToken::CLASS;
	genericmanager::detail::ElementClassImpl<ParserToken, PragmaParserToken, (uint32)ParserToken::Type::PRAGMA> PragmaParserToken::CLASS;
	genericmanager::detail::ElementClassImpl<ParserToken, LabelParserToken, (uint32)ParserToken::Type::LABEL> LabelParserToken::CLASS;
	genericmanager::detail::ElementClassImpl<ParserToken, ConstantParserToken, (uint32)ParserToken::Type::CONSTANT> ConstantParserToken::CLASS;
	genericmanager::detail::ElementClassImpl<ParserToken, StringLiteralParserToken, (uint32)ParserToken::Type::STRING_LITERAL> StringLiteralParserToken::CLASS;
	genericmanager::detail::ElementClassImpl<ParserToken, IdentifierParserToken, (uint32)ParserToken::Type::IDENTIFIER> IdentifierParserToken::CLASS;
#endif
	...
	namespace
	{
		...
		static bool varTypeLookup_initialized = false;
		static void init_varTypeLookup()
		{
			if (varTypeLookup_initialized) return;
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("void"),		&PredefinedDataTypes::VOID));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("s8"),		&PredefinedDataTypes::INT_8));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("s16"),		&PredefinedDataTypes::INT_16));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("s32"),		&PredefinedDataTypes::INT_32));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("s64"),		&PredefinedDataTypes::INT_64));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("bool"),		&PredefinedDataTypes::UINT_8));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("u8"),		&PredefinedDataTypes::UINT_8));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("u16"),		&PredefinedDataTypes::UINT_16));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("u32"),		&PredefinedDataTypes::UINT_32));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("u64"),		&PredefinedDataTypes::UINT_64));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("float"),	&PredefinedDataTypes::FLOAT));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("double"),	&PredefinedDataTypes::DOUBLE));
			varTypeLookup.insert(std::make_pair(rmx::constMurmur2_64("string"),	&PredefinedDataTypes::STRING));
			varTypeLookup_initialized = true;
		}

		static std::map<uint64, Keyword> keywordLookup;
		static bool keywordLookup_initialized = false;
		static void init_keywordLookup()
		{
			if (keywordLookup_initialized) return;
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("function"),		Keyword::FUNCTION));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("global"),		Keyword::GLOBAL));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("constant"),		Keyword::CONSTANT));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("define"),		Keyword::DEFINE));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("declare"),		Keyword::DECLARE));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("return"),		Keyword::RETURN));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("call"),			Keyword::CALL));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("jump"),			Keyword::JUMP));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("break"),		Keyword::BREAK));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("continue"),		Keyword::CONTINUE));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("if"),			Keyword::IF));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("else"),			Keyword::ELSE));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("while"),		Keyword::WHILE));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("for"),			Keyword::FOR));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("addressof"),	Keyword::ADDRESSOF));
			keywordLookup.insert(std::make_pair(rmx::constMurmur2_64("makeCallable"), Keyword::MAKECALLABLE));
			keywordLookup_initialized = true;
		}

		static std::vector<const char*> reservedKeywords;
		static bool reservedKeywords_initialized = false;
		static void init_reservedKeywords()
		{
			if (reservedKeywords_initialized) return;
			const char* arr[] = {
			...
			for (size_t i = 0; i < sizeof(arr)/sizeof(arr[0]); ++i)
				reservedKeywords.push_back(arr[i]);
			reservedKeywords_initialized = true;
		}
#endif
		...
		void analyseIdentifier(const std::string_view& identifier, ParserTokenList& outTokens, uint32 lineNumber)
		{
			...
			// Check for reserved identifier
			{
				if (reservedKeywordLookup.empty())
				{
					...
					{
						reservedKeywordLookup.insert(std::make_pair(rmx::getMurmur2_64(str), str));
					}
				}
			...
			static const uint64 trueHash  = rmx::constMurmur2_64("true");
			static const uint64 falseHash = rmx::constMurmur2_64("false");
