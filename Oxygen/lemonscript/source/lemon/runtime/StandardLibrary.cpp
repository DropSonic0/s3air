...
namespace lemon
{
	namespace functions
	{
		...
		template<typename T> bool Math_isNumber(T value)		{ return isnormal(value) || (value == (T)0); }
		template<typename T> bool Math_isNaN(T value)			{ return isnan(value); }
		template<typename T> bool Math_isInfinite(T value)		{ return isinf(value); }
